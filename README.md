...
Everyone interacting in the Rspec::GraphQL::Response project’s codebases, issue trackers, chat rooms and mailing lists is expected to follow the [code of conduct](https://github.com/[USERNAME]/rspec-graphql_response/blob/master/CODE_OF_CONDUCT.md).
